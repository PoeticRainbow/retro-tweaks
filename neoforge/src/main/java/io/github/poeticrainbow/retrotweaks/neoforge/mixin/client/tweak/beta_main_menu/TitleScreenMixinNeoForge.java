...
public abstract class TitleScreenMixinNeoForge extends Screen {
    ...
    @WrapOperation(method = "extractRenderState", at = @At(target = "Lnet/neoforged/neoforge/internal/BrandingControl;forEachLine(ZZLjava/util/function/BiConsumer;)V", value = "INVOKE"))
    private void retrotweaks$override_neoforge_line_consumer(boolean includeMC, boolean reverse, BiConsumer<Integer, String> lineConsumer, Operation<Void> original, @Local(argsOnly = true, name = "graphics") GuiGraphicsExtractor graphics) {
        if (Tweaks.DIRT_GUI_BACKGROUND.get()) {
            original.call(includeMC, reverse, (BiConsumer<Integer, String>) (i, line) -> {
                ...
                graphics.text(this.font, line, 2, 2 + (i * 10), 0xFF505050);
            });
        } else {
